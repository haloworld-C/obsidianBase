...
| git reset HEAD[file]                                          | 将文件状态恢复当当前head记录的状态                                           |                                                                                                                                 | git reset HEAD, 撤销所有上一步add文件                              |
...
| git tag -a [tag name]                                         | 给重要阶段快照打tag以便永久记忆                                             | -a 打开编辑器添加注释<br>tag需要显示推送到远程仓库                                                                                                  | git tag -a v0.7.3.8 -m "Merged after release 0.7.3.8"<br> |
